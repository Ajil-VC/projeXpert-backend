...
userRouter.get('/all-sprints', authenticateUser, autherizer.hasAny(['view_all_task', 'view_task', 'view_sprint']), backlogControllerInterface.getAllSprintsInProject);
userRouter.get('/tasks/sprint/:sprintId', authenticateUser, autherizer.has(['view_all_task', 'view_task']), backlogControllerInterface.getSprintWithTasks);

userRouter.get('/sprints/:projectId', authenticateUser, autherizer.has(['view_sprint', 'view_task', 'view_all_task',]), backlogControllerInterface.getSprints);
